*! dominance.mata version 1.0.0  xx/xx/202x Joseph N. Luchman
...
void dominance(
 ...
 /*all subsets regressions and progress bar syntax if predictors or sets of predictors is above 5*/
	...
	//fitstat = rowsum(general_dominance) + model_specs.all_fitstat + model_specs.cons_fitstat //total fitstat is then sum of gen. dom. wgts replacing the constant-only model and the "all" subsets stat
